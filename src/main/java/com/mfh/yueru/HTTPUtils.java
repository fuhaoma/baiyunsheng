...
public class HTTPUtils {
  private static final String URL = "https://saas.lianyuplus.com/saas20/api/201410011/";

  public static LoginEntity login() {
    Request request = new Request.Builder()
      .post(RequestBody.create(MediaType.parse("application/json; charset=utf-8"), ""))
      .url(URL+"AptGuest/sysLogin/customer/authenticate" +
  ...
  public static void doorLockHttp() {
    ...
    Request request = new Request.Builder()
      ...
      .url(URL+"AptGuest/doorlock/batchAddWithArea" +
  ...
  public static void deleteDoorLockHttp(String token) {
    Request request = new Request.Builder()
      .post(RequestBody.create(MediaType.parse("application/application/x-www-form-urlencoded; charset=utf-8"), ""))
      .addHeader("intebox_sso_tkt", token)
      .url(URL+"AptGuest/ads/showads/disable?positionId=6&roomId=16774")
      .build();
    OkHttpClient okHttpClient = new OkHttpClient();
    Call call = okHttpClient.newCall(request);
    try {
  ...
  public static String getDoorLockHttp(String token) {
    Request request = new Request.Builder()
      .post(RequestBody.create(MediaType.parse("application/application/x-www-form-urlencoded; charset=utf-8"), ""))
      .addHeader("intebox_sso_tkt", token)
      .url(URL + "AptGuest/doorlock/keysandpower?operatorId=57643&areaId=16774")
      .build();
    OkHttpClient okHttpClient = new OkHttpClient();
    Call call = okHttpClient.newCall(request);
    try {
